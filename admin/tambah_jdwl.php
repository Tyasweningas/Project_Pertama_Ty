    ...
    <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="index.php"><i class="fas fa-user-graduate "></i>Daftar Mahasiswa</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="jadwal.php"><i class="far fa-calendar-alt "></i>Jadwal Kuliah</a>
                    <hr class="bg-secondary">
                </li>
            </ul>
        </div>
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-user-graduate mr-2"></i>Daftar JADWAL KULIAH</h3>
            <hr>
            <form action="simpan_jdwl.php" method="post">
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="pengajar" class="form-control" id="pengajar">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
